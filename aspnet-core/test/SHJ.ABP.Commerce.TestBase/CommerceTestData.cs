...
public class CommerceTestData : ISingletonDependency
{
    public CommerceAuditLogTestData AuditLog { get; } = new();
    ...
    public string Page_1_Title { get; } = "Imagine Dragons - Believer Lyrics".ToLower();
    ...
    public string Page_2_Title { get; } = "Imagine Dragons - Believer Lyrics (Page 2)".ToLower();
...
public class CommerceAuditLogTestData
{
    public int SizeCreateEntity => 5;
